...
class MovingTargetDefense(MtdSwitch):
    ...
    def _packet_in_handler(self, ev):
        ...
        if ipv6_header.src == "fe80::200:ff:fe00:2" and ipv6_header.dst == neighbor_solicitation_multicast_addr(virt_addr) and icmpv6_header.type_ == icmpv6.ND_NEIGHBOR_SOLICIT:
            print("1")
            match=parser.OFPMatch(eth_type=0x86DD,
                                  in_port=in_port,
                                  ipv6_src="fe80::200:ff:fe00:2",
                                  ipv6_dst=neighbor_solicitation_multicast_addr(virt_addr),
                                  icmpv6_type=icmpv6.ND_NEIGHBOR_SOLICIT)
            actions.append(parser.OFPActionSetField(ipv6_dst=neighbor_solicitation_multicast_addr(real_addr)))
        ...
        elif ipv6_header.src == "fe80::200:ff:fe00:2" and ipv6_header.dst == real_addr and icmpv6_header.type_ == icmpv6.ICMPV6_ECHO_REQUEST:
            print("5")
            return
